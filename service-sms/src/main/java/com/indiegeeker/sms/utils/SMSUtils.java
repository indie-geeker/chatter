package com.indiegeeker.sms.utils;

import com.indiegeeker.sms.bean.TencentCloudProperties;
...
public class SMSUtils {
    ...
    public void sendSMS(List<String> mobileList, String code) {
        try {
            ...
            String sdkAppId = tencentCloudProperties.getSdkAppId();
            req.setSmsSdkAppId(sdkAppId);
            /* 短信签名内容: 使用 UTF-8 编码，必须填写已审核通过的签名 */
            // 签名信息可前往 [国内短信](https://console.cloud.tencent.com/smsv2/csms-sign) 或 [国际/港澳台短信](https://console.cloud.tencent.com/smsv2/isms-sign) 的签名管理查看
            String signName = tencentCloudProperties.getSignName();
            ...
            String[] phoneNumberSet = new String[mobileList.size()];
            for(int i = 0; i < mobileList.size(); i++){
                String phone = mobileList.get(i);
